...
/**
 * update-system.mjs — Safe auto-updater for jobhunt-india
 *
...
const CANONICAL_SKILL_PATH = '.agents/skills/jobhunt-india/SKILL.md';
const SKILL_ENTRYPOINTS = [
  {
    path: '.claude/skills/jobhunt-india/SKILL.md',
    pointer: '../../../.agents/skills/jobhunt-india/SKILL.md',
  },
  {
    path: '.opencode/skills/jobhunt-india/SKILL.md',
    pointer: '../../../.agents/skills/jobhunt-india/SKILL.md',
  },
];
...
async function check() {
  ...
  const [rawVersion, releaseRaw] = await Promise.all([
    ...
    curlGet(RELEASES_API, [
      ...
      '--header', 'User-Agent: jobhunt-india-update-checker',
    ]),
  ]);
