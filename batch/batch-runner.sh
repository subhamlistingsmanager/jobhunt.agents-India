...
# jobhunt-india batch runner — standalone orchestrator for claude -p workers
...
usage() {
  cat <<'USAGE'
jobhunt-india batch runner — process job offers in batch via claude -p workers
...
main() {
  ...
  echo "=== jobhunt-india batch runner ==="
