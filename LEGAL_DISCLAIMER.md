...
`jobhunt-india` is a collection of Markdown prompts, Node.js scripts, and HTML templates. It is strictly a local execution tool. The maintainers do not host, deploy, or operate an AI system, nor do we provide API access to Large Language Models (LLMs).
...
jobhunt-india interacts with career portals and job boards (Greenhouse, Lever, Ashby, Workday, and others).
...
jobhunt-india is designed to help individuals make better career decisions, not to automate away human judgment. Acceptable use includes:
...
The "jobhunt-india" name and brand identity are separate from the MIT
...
The "Job Hunts Agent India" name is used for this project; the underlying MIT-licensed code may be freely reused.
