...
A large share of Indian roles fill through **referrals**, so referral outreach is high-value here. Keep messages **polite and warm** (a slightly more courteous register than a cold Western pitch lands better) and **referral-driven**: when messaging a Peer or a current employee, it is acceptable — once rapport exists — to ask whether they would be open to **referring** you for the specific role, naming it. With Recruiters/Hiring Managers, mention you are happy to be referred internally if a fit exists. Stay concise and never pushy. When relevant to a recruiter, you may note **notice-period / availability** so they can gauge timeline (e.g. "available after a 30-day notice").
