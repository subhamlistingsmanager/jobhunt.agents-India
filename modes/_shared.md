...
<!-- ============================================================
     ...
     that improve with each jobhunt-india release.
     ============================================================ -->
...
**India note:** For roles in India, assess **Comp** as total **CTC (fixed + variable + ESOP) vs market in ₹ LPA**, not headline salary alone. Add two signals: **Notice period / joining timeline** (30/60/90-day notice, buyout exposure, ASAP-start mismatch) as a red-flag/cultural signal, and **ESOP/variable realism** (how much of the quoted CTC is actually cash vs notional upside) under cultural signals. See `modes/oferta.md` Block D and `docs/INDIAN-JOB-SOURCES.md`.
